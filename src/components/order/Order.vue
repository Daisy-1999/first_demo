<template>
    <div>
            ...
            <el-table :data="orderlist" border stripe="">
                ...
                <el-table-column label="是否付款" prop="order_status">
                    <template v-slot="slot">
                        <el-tag type="success" v-if="slot.row.order_status === '1'">已付款</el-tag>
        ...
        <el-dialog
            ...
            :rules="addressFormRules" label-width="100px">
        ...
        <el-dialog
            title="物流进度"
            :visible.sync="prgoressVisible"
            width="50%">
           
            <span slot="footer" class="dialog-footer">
                <el-button @click="prgoressVisible = false">取 消</el-button>
                <el-button type="primary" @click="prgoressVisible = false">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
